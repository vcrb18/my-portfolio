    ...
    <div className="">
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        <p className="text-sm text-[#d3d8e8]">
          {
            "Si tienes alguna pregunta o inquietud, no dudes en contactarme. Estoy abierto a cualquier oportunidad de trabajo que se alinee con mis habilidades e intereses."
          }
        </p>
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-2">
            {error.required && (
              <p className="text-sm text-red-400">
                ¡El correo electrónico y el mensaje son obligatorios!
              </p>
            )}
            <button
